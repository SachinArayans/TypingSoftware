...
function loadDoc(url,type) {
   ...
   function monitorcheck(d) {
    ...
    function indicate(a) {
        ...
        if (a == 72 || a == 73 || a == 74 || a == 75 || a == 76 || a == 77 || a == 78 || a == 79 || a == 80 || a == 85 || a == 89 || a == 58 || a == 60 || a == 62 || a == 63 || a == 94 || a == 38 || a == 42 || a == 40 || a == 41 || a == 95 || a == 43 || a == 124 || a == 123 || a == 125 || a == 58 || a == 34) {
    ...
    function removeh(a){
        ...
        key[0].style.background = "#ffbf00";
         ...
         document.getElementsByClassName("shiftright")[0].style.background = "#ffbf00";
         document.getElementsByClassName("shiftright")[1].style.fill = "#1F1A17";         
         document.getElementsByClassName("shiftleft")[0].style.background = "#ffbf00";
         document.getElementsByClassName("shiftleft")[1].style.fill = "#1F1A17";       
    }
    ...
    function indicate2(a, b) {
        ...
        if (y == 65 || y == 66 || y == 67 || y == 68 || y == 69 || y == 70 || y == 71 || y == 81 || y == 82 || y == 83 || y == 84 || y == 86 || y == 87 || y == 88 || y == 90 || y == 126 || y == 33 || y == 64 || y == 35 || y == 36 || y == 37) {
       ...
       else if (y == 72 || y == 73 || y == 74 || y == 75 || y == 76 || y == 77 || y == 78 || y == 79 || y == 80 || y == 85 || y == 89 || y == 58 || y == 60 || y == 62 || y == 63 || y == 94 || y == 38 || y == 42 || y == 40 || y == 41 || y == 95 || y == 43 || y == 124 || y == 123 || y == 125 || y == 58 || y == 34) {
            press.innerHTML = "<span style='font-size:15px;'>First Press <table id='buttons'leftmargin='50'style='display:inline-block;'><tr><td id='a3' style='opacity:1.2;width:100px;'>Shift</td></tr></table> With Left Baby finger then</span> <table id='buttons'leftmargin='50'style='display:inline-block;'><tr><td id='a3' style='opacity:1.2;'>" + String.fromCharCode(y).toUpperCase() + "</td></tr></table><span style='font-size:15px;'> with" + finger+"</span>";  
                             ...
                             press.innerHTML = "Press <span style='font-size:15px;'> <table id='buttons'leftmargin='50'style='display:inline-block;'><tr><td id='a3' style='opacity:1.2;width:200px;'> &nbsp;&nbsp;&nbsp; Spacebar &nbsp;&nbsp;&nbsp;</td></tr></table> with Thumb</span>";
                         }
     else{ 
